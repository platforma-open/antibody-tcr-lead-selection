...
import { platforma } from "@platforma-open/milaboratories.top-antibodies.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type TopAntibodiesBlockContract = BlockContract;
export type TopAntibodiesBlockOutputs  = BlockOutputs;
export type TopAntibodiesBlockData     = BlockData;
export const TopAntibodiesBlockPointer = BlockPointer;
